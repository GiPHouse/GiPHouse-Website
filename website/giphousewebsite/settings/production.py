...
DJANGO_GITHUB_SYNC_ORGANIZATION_NAME = os.environ[
    "DJANGO_GITHUB_SYNC_ORGANIZATION_NAME"
]
DJANGO_GITHUB_SYNC_APP_ID = os.environ["DJANGO_GITHUB_SYNC_APP_ID"]
DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY_BASE64 = os.environ[
    "DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY_BASE64"
]
DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY = base64.urlsafe_b64decode(
    DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY_BASE64
)
DJANGO_GITHUB_SYNC_APP_INSTALLATION_ID = os.environ[
...
GSUITE_ADMIN_CREDENTIALS_BASE64 = os.environ[
    "DJANGO_GSUITE_ADMIN_CREDENTIALS_BASE64"
]
