...
DJANGO_GITHUB_SYNC_ORGANIZATION_NAME = os.environ.get(
    "DJANGO_GITHUB_SYNC_ORGANIZATION_NAME", ""
)
DJANGO_GITHUB_SYNC_APP_ID = os.environ.get("DJANGO_GITHUB_SYNC_APP_ID", "")
DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY_BASE64 = os.environ.get(
    "DJANGO_GITHUB_SYNC_APP_PRIVATE_KEY_BASE64", ""
)
DJANGO_GITHUB_SYNC_APP_INSTALLATION_ID = os.environ.get(
