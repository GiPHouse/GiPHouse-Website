...
class ModelTest(TestCase):
    ...
    def test_create_lecture_same_title(self):
        new_semester = Semester.objects.create(
            year=self.year + 1, season=self.season
        )
    ...
    def test_current_semester_spring(self):
        ...
        testsem = Semester.objects.create(
            ...
            registration_start=startreg,
            registration_end=endreg,
        )
        self.assertEqual(
            testsem, Semester.objects.get_or_create_current_semester()
        )
    ...
    def test_create_current_semester_fall_last_year(self):
        self.assertEqual(
            Semester.objects.get_or_create_current_semester().season,
            Semester.FALL,
        )
